...
async function getAuthHeaders(): Promise<Record<string, string>> {
  if (IS_LOCAL_TEST) {
    return { Authorization: "Bearer localtest", "Content-Type": "application/json" };
  }
...
export const googleTasksApi = {
  ...
  connect: () => {
    // Navigate away to start OAuth flow
    window.location.href = "/api/connectors/google-tasks/auth";
  },
